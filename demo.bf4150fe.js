...
},{"underscore":"../node_modules/underscore/underscore.js"}],"../src/views/text.js":[function(require,module,exports) {
...
module.exports = Backbone.View.extend({
    ...
    doRender: function doRender() {
        ...
        if (!(html instanceof jQuery) && !/^</.test(html)) html = '<p>' + html + '</p>';

        this.$el.html(html);
    }
});
},{"backbone":"../node_modules/backbone/backbone.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../src/views/date-picker.js":[function(require,module,exports) {
...
module.exports = Backbone.View.extend({
    ...
    render: function render() {
        ...
        if (!this.date1) if (window.DatePicker) this.renderPickers(window.DatePicker);else {
            this.date1.reset();
    ...
    renderPickers: function renderPickers(DatePicker) {
    ...
    save: function save() {
        ...
        if (!this.date1.value()) return this.date1.$el.pulse();

        if (this.opts.range && !this.date2.value()) return this.date2.$el.pulse();

        if (this.opts.range) this.options.item.val = [this.date1.value(), this.date2.value()];else this.options.item.val = this.date1.value();

        // make sure earlier date is first
        if (this.opts.range && this.options.item.val[0] > this.options.item.val[1]) this.options.item.val = [this.options.item.val[1], this.options.item.val[0]];

        this.options.onClick(this.options.item);
    }

});
},{"backbone":"../node_modules/backbone/backbone.js"}],"../node_modules/liquidmetal/liquidmetal.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/**
...
},{}],"../src/views/menu.js":[function(require,module,exports) {

var Backbone = require('backbone');
var $ = require('jquery');
var MenuDatePickerView = require('./date-picker');
...
module.exports = Backbone.View.extend({
    ...
    initialize: function initialize(menu, opts) {
        ...
        this.options = _.extend({
            ...
            searchNoResultItem: function searchNoResultItem(dd) {
                return { label: 'No Results for "' + dd.term + '"' };
            },
            closeOnClick: true
        ...
        if (this.options.viewFn) this.menu = this.options.viewFn(this, this.options);
    ...
    render: function render() {
        ...
        if (this.options.collection && this.options.autoFetch) {
            ...
            if (this.options.collectionFn) this.options.collection = this.options.collectionFn.call(this.context());
            ...
            if (coll.length == 0) this.$ul.html('<p style="padding: 10px; word-break: normal;">Loading...</p>');else this._render();
    ...
    _render: function _render() {
        ...
        if (this.options.viewFn) {
            ...
            if (!_.isArray(this.menu)) {
                ...
                if (this.menu) this.options.noResultsMsg = this.menu;
    ...
    toggleSearch: function toggleSearch() {
        if (this.searchVisible()) {
            if (!this.$searchView) {
                this.$searchView = $('<div class="search-bar"></div>').prependTo(this.$el).append(this.$search = $('<input type="text" class="search" placeholder="' + this.options.searchPlaceholder + '">').on('keyup', this.onSearch.bind(this)));
            }
    ...
    onSearch: function onSearch(e) {
        ...
        if (e.which == 38) {
            ...
            if (this._hoverIndxItem) _.defer(function () {
                this._hoverIndxItem.click();
            }.bind(this));
        } else {
    ...
    _hoverItem: function _hoverItem(move) {
        ...
        if (move == 0) this._hoverIndx = 0;else this._hoverIndx += move;

        // to far, loop back
        if (this._hoverIndx >= this._visibleItems.length) this._hoverIndx = 0;else if (this._hoverIndx < 0) this._hoverIndx = this._visibleItems.length - 1;
    ...
    addItems: function addItems() {
        ...
        if (this.menu && this.menu.length > 0) {
            ...
            this._visibleItems = _.filter(items, function (val) {
                return val;
            });
            ...
            if (this.term) {
                ...
                if (this._visibleItems.length == 0 && this.options.searchNoResultItem) {
                    ...
                    if (_.isFunction(noResultItem)) noResultItem = noResultItem.call(this.context(), this);
    ...
    addItem: function addItem(item) {
        ...
        if (_.isFunction(item)) item = item.call(this.context(), this);

        if (item && (item === 'divider' || item.divider) && !this.term) return this.addDivider(item);

        if (item && item.text && !this.term) return this.addText(item);
        ...
        if (this.term && item._noResultItem !== true && this.searchScore(item)) return false;
        ...
        if (item.permission && !Dropdown.permission(item.permission)) return false;

        var className = item.className;
        var iconClassName = item.icon ? 'icon-' + item.icon : '';

        if (this.options.theme == 'select') iconClassName += ' icon-plus';

        if (item.disabled == true) className += ' disabled';

        var selected = this.options.selected;selected = _.isFunction(selected) ? selected.call(this.context()) : selected;

        if (item.selected === true || !item.input && !item.datepicker && selected !== null && selected !== undefined && (selected == item.val || _.isArray(selected) && _.contains(selected, item.val))) className += ' selected';

        if (item.label.jquery) {
            var $li = $('<li data-val="' + item.val + '" class="' + className + '" title="' + item.title + '"></li>').append(item.label).appendTo($el);

            if (item.description) $li.append('<span class="description">' + item.description + '</span>');
        } else {

            var $li = $('<li data-val="' + item.val + '" class="' + className + '" title="' + item.title + '">\
                            <span class="' + iconClassName + '">' + item.label + '\
                            <span class="description">' + item.description + '</span>' + (item.options ? '<span class="options badge gray-50 icon-only icon-options"></span>' : '') + '</span>\
                        </li>').appendTo($el);
        }
        ...
        if (item.dataAttrs) _.each(item.dataAttrs, function (val, key) {
            $li.attr('data-' + key, val);
        });

        if (item.border) $li.css('border-right', 'solid 4px ' + this.borderColor(item.border));
        ...
        if (item.input) item.dropdown = {
            ...
            if (item.datepicker.preset) {
                if (!Dropdown.Presets.DatePicker[item.datepicker.preset]) console.warn('Dropdown: `' + item.datepicker.preset + '` is not valid preset in Dropdown.Presets.DatePicker');else item.datepicker = _.extend({}, Dropdown.Presets.DatePicker[item.datepicker.preset], item.datepicker);
            }
        ...
        } else if ((item.onClick || this.options.onClick) && item.onClick !== false && !item.dropdown) $li.click(_.bind(function () {

            if (item.disabled == true) return;

            if (item.onClick === 'trigger') {
                // this onClick is deprecated (haven't used it for a while and dont think its useful anymore)
                this.trigger('click', item, $li);
            } else {

                var fn = this._determineOnClickMethod(item);

                if (fn) fn(item, $li, this.options.opts || this.options, this);
                // TODO: remove `this.options.opts` (left for legacy support)
            }

            if (this.options.closeOnClick && item.closeOnClick !== false) this.close();else this.render();
        }, this));
    ...
    addDivider: function addDivider(item) {

        var $el = this.$ul ? this.$ul : this.$el;

        if (item.divider) $('<li class="label-divider not-menu clear ' + (item.className || '') + '">' + item.divider + '</li>').appendTo($el);else $('<li class="divider not-menu clear"></li>').appendTo($el);
    },

    addText: function addText(item) {
    ...
    borderColor: function borderColor(color) {
        switch (color) {
            case 'gray':
                return '#ccc';break;
            case 'blue':
    ...
    _determineOnClickMethod: function _determineOnClickMethod(item) {
...
},{"backbone":"../node_modules/backbone/backbone.js","jquery":"../node_modules/jquery/dist/jquery.js","./date-picker":"../src/views/date-picker.js","liquidmetal":"../node_modules/liquidmetal/liquidmetal.js"}],"../src/views/input-select.js":[function(require,module,exports) {
...
module.exports = Backbone.View.extend({
    ...
    render: function render() {
        ...
        if (this.opts.title) this.$el.append('<label class="dropdown-input-title">' + this.opts.title + '</label>');
        ...
        if (this.opts.range == true) this.$input2 = $('<input type="text" style="width: 100%;" placeholder="' + placeholder + '" value="' + val2 + '">').appendTo(this.$el);

        setTimeout(this.focus.bind(this), 200);

        if (this.opts.footer) this.$el.append('<div class="dropdown-input-footer">' + this.opts.footer + '</div>');

        if (this.opts.btn) this.$el.append('<p class="label-divider footer clear clearfix"><a class="right btn primary">' + (typeof this.opts.btn == 'string' ? this.opts.btn : 'Select') + '</a></p>');
    },
    ...
    submitVal: function submitVal() {
        ...
        if (!pattern.test(val)) return this.$input.bounce();

        if (this.opts.range == true) {
            var val2 = this.$input2.val();

            if (!pattern.test(val2)) return this.$input2.bounce();
        }

        if (val2) this.options.item.val = [val, val2]; // set this so the value will be used
        else this.options.item.val = val; // set this so the value will be used

        this.options.onClick(this.options.item);
    }
});
},{"backbone":"../node_modules/backbone/backbone.js","jquery":"../node_modules/jquery/dist/jquery.js"}],"../src/dropdown.js":[function(require,module,exports) {
var _this = this;
...
var DropdownMenuInputSelectView = require('./views/input-select');
var DetermineViewMap = new Map();

Backbone.$ = $;

DetermineViewMap.set(function (dd) {
    return _.isString(dd.view) || dd.view instanceof jQuery;
}, function (dd) {
    return new TextView(_.extend({}, _this.options, { html: dd.view }));
});

DetermineViewMap.set(function (dd) {
    return _.isArray(dd.view);
}, function (dd) {
    return new MenuView(dd.view, dd.options);
});
...
var Dropdown = Backbone.View.extend({
    ...
    initialize: function initialize(opts) {
        ...
        if (this.options.trigger === 'delay') this.bindDelayedTrigger();
        if (this.options.trigger === 'hover') this.bindHoverTrigger();else if (this.options.trigger !== 'none') this.options.renderTo[0].addEventListener(this.options.trigger, this.toggle.bind(this), false);
        ...
        if (this.options.openOnInit && this.options.trigger === 'delay') this.delayStart();else if (this.options.trigger === 'none' || this.options.openOnInit) _.defer(this.toggle.bind(this));
    },
    ...
    _bindEvents: function _bindEvents() {
        ...
        if (this.options.closeOnScroll && this.options.renderTo.scrollParent && this.options.renderTo.scrollParent()[0]) this.options.renderTo.scrollParent()[0].addEventListener('scroll', this.deferClose, true);

        // watch for esc or enter key
        if (this.options.closeOnEsc || this.options.actionOnEnter) document.body.addEventListener('keyup', this.onKeyup, false);
    },
    ...
    _unbindEvents: function _unbindEvents() {
        ...
        // FIXME
        if (this.options.renderTo.scrollParent && this.options.renderTo.scrollParent()[0]) this.options.renderTo.scrollParent()[0].removeEventListener('scroll', this.deferClose);
    },

    unbindTrigger: function unbindTrigger() {

        if (this.options.trigger === 'delay') this.unbindDelayedTrigger();
        if (this.options.trigger === 'hover') this.unbindHoverTrigger();else if (this.options.trigger !== 'none') this.options.renderTo.unbind(this.options.trigger, this.toggle.bind(this));
    },

    bindHoverTrigger: function bindHoverTrigger() {
        this.options.renderTo.bind('mouseenter', this.open.bind(this));
        this.options.renderTo.bind('mouseleave', this.delayEnd.bind(this));
    },

    unbindHoverTrigger: function unbindHoverTrigger() {
    ...
    bindDelayedTrigger: function bindDelayedTrigger() {
        this.options.renderTo.bind('mouseenter', this.delayStart.bind(this));
        this.options.renderTo.bind('mouseleave', this.delayEnd.bind(this));
    },

    unbindDelayedTrigger: function unbindDelayedTrigger() {
    ...
    setup: function setup() {
        ...
        if (this.options.animated) this.$el.addClass('animate');
    ...
    determineView: function determineView() {
        ...
        DetermineViewMap.forEach(function (createFn, testFn) {

            if (createdView) return;

            if (testFn(_this2)) createdView = createFn(_this2);
        });
    ...
    toggle: function toggle(e) {
        ...
        if (this.isOpen !== true) this.open(e);else this.close(e);
    },
    ...
    close: function close(e) {
        ...
        var exit = false;
        if (e && e.path) e.path.forEach(function (path) {
            if (path.id === 'ui-datepicker-div') exit = true;
        });
        if (exit) return;
        ...
        if (this.options.onClose) {
            if (_.isFunction(this.options.onClose)) this.options.onClose();else if (_.isString(this.options.onClose) && this.options.context[this.options.onClose]) this.options.context[this.options.onClose].call(this.options.context);
        }
    ...
    actionOnEnter: function actionOnEnter(e) {
        if (this.view.actionOnEnter) this.view.actionOnEnter(e); // view must have an "actionOnEnter" method for this to work
    },

    _deferClose: function _deferClose(e) {
        this.deferCloseTimeout = setTimeout(this.close.bind(this, e), 0);
    },

    _stopDeferClose: function _stopDeferClose(e) {
        clearTimeout(this.deferCloseTimeout);
    },
    ...
    adjustPosition: function adjustPosition() {
        ...
        if (align === 'left' || align === 'right') this.alignVerticalMiddle();else if (align === 'top' || align === 'bottom') this.alignHorizontalMiddle();else if (align === 'auto') this.autoAlign();else this.autoCenter();
        ...
        if (this.options.alignVerticalToParent) {
            ...
            if (align == 'auto') {
                this.el.style.top = this.options.renderTo[0].offsetTop + this.options.renderTo[0].offsetHeight - this.options.renderTo[0].parentElement.scrollTop;
            } else if (align == 'rightBottom' || this.options.align == 'leftBottom') {
                this.el.style.top = this.options.renderTo[0].offsetTop - this.options.renderTo[0].parentElement.scrollTop;
            } else if (align == 'rightTop' || this.options.align == 'leftTop') {
    ...
    _changeAlignmentIfCovered: function _changeAlignmentIfCovered() {
        var align = this.options.align;

        // this logic is flawed, but better than nothing for now
        if (this.options.adjustIfCovered !== false && this.isCovered()) {

            if (align == 'top') this._switchAlignment('top', 'bottom');else if (align == 'topRight') this._switchAlignment('topRight', 'bottomRight');else if (align == 'topLeft') this._switchAlignment('topLeft', 'bottomLeft');else if (align == 'bottom') this._switchAlignment('bottom', 'top');else if (align == 'bottomRight') this._switchAlignment('bottomRight', 'topRight');else if (align == 'bottomLeft') this._switchAlignment('bottomLeft', 'topLeft');else if (align == 'rightBottom') {
                this._switchAlignment('rightBottom', 'rightTop');
                this.el.style.top = null;
                // FIXME: this is wrong...
                this.el.style.bottom = this.options.renderTo[0].offsetTop + this.options.renderTo[0].offsetHeight - this.options.renderTo[0].parentElement.scrollTop;
            }
        }
    },

    _switchAlignment: function _switchAlignment(before, after) {
    ...
    isCovered: function isCovered() {
        ...
        switch (this.options.align) {
            case 'top':
                onTopEl = document.elementFromPoint(f.left + f.width / 2, f.top + 5);break;
            case 'topRight':
                onTopEl = document.elementFromPoint(f.right - 5, f.top + 5);break;
            case 'topLeft':
                onTopEl = document.elementFromPoint(f.left + 5, f.top + 5);break;

            case 'bottom':
                onTopEl = document.elementFromPoint(f.left + f.width / 2, f.bottom - 5);break;
            case 'bottomRight':
                onTopEl = document.elementFromPoint(f.right - 5, f.bottom - 5);break;
            case 'bottomLeft':
                onTopEl = document.elementFromPoint(f.left + 5, f.bottom - 5);break;
            case 'rightBottom':
                onTopEl = document.elementFromPoint(f.right - 5, f.bottom - 5);break;
        }
    ...
    alignVerticalMiddle: function alignVerticalMiddle() {
    ...
    alignHorizontalMiddle: function alignHorizontalMiddle() {
    ...
    autoAlign: function autoAlign() {

        if (this.align) this.$el.removeClass('align-' + this.align);
        ...
        if (right < 0 && bottom < 0) align = 'topLeft';else if (right < 0) align = 'bottomLeft';else if (bottom < 0) align = 'topRight';
    ...
    autoCenter: function autoCenter() {
        ...
        if (/Left$/.test(this.align)) this.$el.css('right', adjustToCenterArrow);else this.$el.css('left', adjustToCenterArrow);
    }
...
Dropdown.addViewType = function (testFn, createFn) {
    DetermineViewMap.set(testFn, createFn);
};

module.exports = Dropdown;
},{"backbone":"../node_modules/backbone/backbone.js","jquery":"../node_modules/jquery/dist/jquery.js","./views/text":"../src/views/text.js","./views/menu":"../src/views/menu.js","./views/input-select":"../src/views/input-select.js"}],"../src/jquery-plugin.js":[function(require,module,exports) {
...
var plugins = {
    ...
    /*
        jQuery Plugin
    */
    dropdown: function dropdown(view, opts) {
    ...
    openDropdown: function openDropdown(view, opts) {
        opts = opts || {};
    ...
    */
    popover: function popover(view, opts) {
...
},{"jquery":"../node_modules/jquery/dist/jquery.js","./dropdown":"../src/dropdown.js"}],"../index.js":[function(require,module,exports) {
require('./src/jquery-plugin');
module.exports = require('./src/dropdown');
},{"./src/jquery-plugin":"../src/jquery-plugin.js","./src/dropdown":"../src/dropdown.js"}],"index.js":[function(require,module,exports) {
...
document.addEventListener('DOMContentLoaded', function () {
	...
	$('#header-demo').dropdown([{
		...
		icon: 'cog',
		dropdown: {
			view: [{ divider: 'Option Header' }, 'Option 1', 'Option 2', { text: 'Dropdown can render Backbone views, jQuery objects or text and menus can be made from arrays' }],
			w: 200,
			selected: 'Option 1',
			align: 'rightBottom'
		}
...
},{"jquery":"../node_modules/jquery/dist/jquery.js","underscore":"../node_modules/underscore/underscore.js","backbone":"../node_modules/backbone/backbone.js","../index":"../index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/demo.bf4150fe.map